...
type IntroCircuitSplashSectionProps = {
  bootDone: boolean;
  introLogoPng: string;
  onComplete: () => void;
};

const IntroCircuitSplashSection = ({ bootDone, introLogoPng, onComplete }: IntroCircuitSplashSectionProps) => {
  ...
  }, [introLogoPng, onComplete]);

  return (
    <div
      className={`absolute inset-0 z-20 flex items-center justify-center bg-white origin-center transition-[opacity,transform,filter] duration-700 ease-in-out ${
...
export default IntroCircuitSplashSection;
