type WebSolutionsOfferingsSectionProps = {
  title: string;
  intro: string;
  offerings: string[];
};

const WebSolutionsOfferingsSection = ({ title, intro, offerings }: WebSolutionsOfferingsSectionProps) => (
...
export default WebSolutionsOfferingsSection;
