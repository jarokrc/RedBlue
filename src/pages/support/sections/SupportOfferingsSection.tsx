type SupportOfferingsSectionProps = {
  intro: string;
  title: string;
  offerings: string[];
};

const SupportOfferingsSection = ({ intro, title, offerings }: SupportOfferingsSectionProps) => (
...
export default SupportOfferingsSection;
